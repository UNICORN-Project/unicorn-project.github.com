...
curl -sSL https://github.com/UNICORN-Project/UNICORN/archive/0.4.0.zip > ./UNICORN.zip && \
unzip -o ./UNICORN.zip
rm ./UNICORN.zip
cp -rf ./UNICORN-0.4.0/* ./
cp -rf ./UNICORN-0.4.0/.gitignore ./
rm -rf ./UNICORN-0.4.0
curl -sSL https://github.com/UNICORN-Project/lib/archive/0.4.0.zip > ./lib.zip && \
unzip -o ./lib.zip
rm ./lib.zip
mkdir ./lib
cp -rf ./lib-0.4.0/* ./lib/
